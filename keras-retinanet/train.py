...
def parse_args(args):
    ...
    parser.add_argument('--steps',           help='Number of steps per epoch.', type=int, default=3325)
    parser.add_argument('--snapshot-path',   help='Path to store snapshots of models during training (defaults to \'..\')', default='..')
